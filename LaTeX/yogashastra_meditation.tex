...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Day 5: Rules/Tips of Meditation}
\begin{itemize}
  \item For quality meditations, need to follow some rules/tips.
  \item Divided into three parts:
    \begin{itemize}
      \item Before meditation
      \item While doing meditation
      \item Lifestyle during the whole day
    \end{itemize}
\end{itemize}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Before Meditation}
\begin{itemize}
  \item Some activity involving breath or light exercise helps.
  \item Body and mind should be calm before starting.
\end{itemize}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{While Doing Meditation}
\begin{itemize}
  \item Practice two times daily, 20 minutes each, at fixed times.
  \item Ideally 2 hours before eating — body needs oxygen, breath should not slow down.
  \item Not just before sleep, as meditation makes you fresh.
  \item Do it before 7 pm or just before lunch.
  \item Stomach should be empty and no immediate nature call required.
\end{itemize}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Lifestyle During the Day}
\begin{itemize}
  \item Diet (Aahar) should be ‘satvik’ — food that suits the body, not just vegetarian.
  \item Whatever happens before meditation affects it, and after it, meditation influences actions.
  \item Maintain morals (tatvanistha): honesty, punctuality, no corruption, no lies.
  \item Avoid negative influences: social media, violent/immoral content, gossip, depressing books.
  \item Avoid disturbances from events, people, memories, places, and objects. 
  \item Mind control is the key.
\end{itemize}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Exercise: Handling Thoughts}
\begin{itemize}
  \item Once eyes are closed, thoughts come one by one, often unrelated.
  \item Goal: stay on a single thought, do not let it go.
  \item Thought can be pre-selected or the first that arises in meditation.
  \item Hold that thought steadily for 20 minutes.
  \item It may be a memory or a question (e.g., a college trip).
  \item Avoid branching into other related thoughts.
  \item Also called \textbf{Transcendental Meditation} — started by Maharshi Mahesh Yogi (84 Kutiya, Rishikesh).
  \item \textbf{Namasmarn} — name chanting, similar in practice.
\end{itemize}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Day 6: How to Get into the Subconscious Mind?}
    \begin{itemize}
        \item As per Indian ancient texts (Puranas), Yugas and Vishnu avatars:
        \begin{itemize}
            \item Satya Yuga – 4 avatars: Matsya, Kurma, Varaha, Narasimha
            \item Treta Yuga – Vamana, Parashuram, Ram
            \item Dwapar Yuga – Krishna, Buddha
            \item Kali Yuga – Kalki
        \end{itemize}
        \item Every Yuga has both goodness and badness.
        \item Keep faith in being good and moral.
        \item No need to adopt all morals; select what resonates.
        \item Against bad people, tit-for-tat approach is acceptable.
        \item The bottom line: remain calm and fine at the end.
    \end{itemize}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Purpose of Life and Self-Knowledge}
    \begin{itemize}
        \item The purpose of life is only to know yourself.
        \item Psychological patterns cover the inner self.
        \item Forgetting these patterns helps uncover your true self.
        \item Other life purposes are fine; follow your flow.
        \item No rigid goals are necessary.
    \end{itemize}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Law of Attraction and Manifestation}
    \begin{itemize}
        \item Wishing for something aligns with the law of attraction.
        \item Repeating a wish is called affirmation – it hammers the subconscious mind.
        \item When a wish comes true, it's called manifestation.
        \item Once something enters the subconscious, good or bad, it’s done!
    \end{itemize}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Spiritual Practice and Subconscious Mind}
    \begin{itemize}
        \item Spiritual practices soften the outer mind.
        \item This allows intent to pass into the subconscious mind.
        \item Some practices directly strengthen the subconscious:
        \begin{itemize}
            \item Tratak
        \end{itemize}
    \end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Exercise: Bindu Tratak}
    \begin{itemize}
        \item Keep eyes open and focus on:
        \begin{itemize}
            \item A dot on the wall (Bindu Tratak)
            \item A flame (Jyoti Tratak)
        \end{itemize}
        \item Benefits:
        \begin{itemize}
            \item Strengthens the subconscious mind
        \end{itemize}
    \end{itemize}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Bindu Tratak – Setup and Practice}
    \begin{itemize}
        \item Use 8" x 8" white paper with 2" diameter black dot at eye level.
        \item Sit 3 feet away; do not blink.
        \item Practice max 20 minutes; start with 5 minutes.
        \item After practice, wash eyes with water.
        \item During meditation, you may see a lighted dot in place of the black dot.
        \item Over time, the black dot disappears, indicating access to the subconscious mind.
        \item Breath slows down or changes.
        \item Practice in the evening twilight; avoid regular practice initially.
    \end{itemize}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Bindu Tratak – Progressive Practice}
    \begin{itemize}
        \item Part II:
        \begin{itemize}
            \item First month – 1 inch dot
            \item Second month – half the size
            \item Third month – very small dot
        \end{itemize}
        \item Gradual training enhances focus and depth of subconscious access.
    \end{itemize}
\end{frame}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Other Tratak Practices}
    \begin{itemize}
        \item \textbf{Pratibimb Tratak:}
        \begin{itemize}
            \item Use 8" x 8" mirror placed 3 feet away.
            \item Focus between the eyebrows on your image.
        \end{itemize}
        \item \textbf{Jyoti Tratak:}
        \begin{itemize}
            \item Candle flame with no other lights.
            \item Start with 5 minutes, increase to max 20 minutes.
            \item Practice twice a day with eyes open.
        \end{itemize}
    \end{itemize}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Meditation and True Nature}
      \begin{itemize}
        \item The pursuit of life is to know your true nature, which is achieved through meditation.
        \item Meditation means thoughtlessness — the vanishing of the mind.
        \item However, this is not the end; spiritual meditation begins from here.
        \item We become aware of \textbf{शून्यावस्था}, where the soul (\textit{atma}) is beyond the mind.
        \item Time and space are creations of the mind.
        \item Sound transcends time and space:
            \begin{itemize}
                \item Beyond space: not bound by location, formless, present everywhere.
                \item Beyond time: free from causation, without beginning or end (\textit{स्थलकालातीत}).
            \end{itemize}
      \end{itemize}
\end{frame}
