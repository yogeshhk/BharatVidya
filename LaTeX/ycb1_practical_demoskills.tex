...
\begin{columns}
    ...
    \begin{column}[T]{0.5\linewidth}
        \begin{center}
        \includegraphics[width=\linewidth,keepaspectratio]{ycb1_kapalbhati}
...
\begin{columns}
    ...
    \begin{column}[T]{0.5\linewidth}
		\begin{center}
		        \includegraphics[width=\linewidth,keepaspectratio]{ycb1_greeva}
...
\begin{columns}
    ...
    \begin{column}[T]{0.5\linewidth}
		\begin{center}
		        \includegraphics[width=\linewidth,keepaspectratio]{ycb1_bhuja}
...
\begin{columns}
    ...
    \begin{column}[T]{0.5\linewidth}
		\begin{center}
		        \includegraphics[width=\linewidth,keepaspectratio]{ycb1_kati}
...
\begin{columns}
    ...
    \begin{column}[T]{0.5\linewidth}
		\begin{center}
		\includegraphics[width=\linewidth,keepaspectratio]{ycb1_jangha}
...
\begin{columns}
    ...
    \begin{column}[T]{0.5\linewidth}
		\begin{center}
		\includegraphics[width=\linewidth,keepaspectratio]{ycb1_sthula_hrid}
...
\begin{frame}[fragile]\frametitle{Sequence of Surya Namaskara}
        ...
        \begin{center}
        \includegraphics[width=\linewidth,keepaspectratio]{ycb1_suryanamaskar}
        \end{center}	
...
\begin{columns}
    ...
    \begin{column}[T]{0.5\linewidth}
        \begin{center}
		        \includegraphics[width=\linewidth,keepaspectratio]{ycb1_tadasan}
...
\begin{columns}
    ...
    \begin{column}[T]{0.5\linewidth}
        \begin{center}
        \begin{center}
		        \includegraphics[width=\linewidth,keepaspectratio]{ycb1_padahastasan}
...
\begin{columns}
    ...
    \begin{column}[T]{0.5\linewidth}
        \begin{center}
        \begin{center}
		        \includegraphics[width=\linewidth,keepaspectratio]{ycb1_katichakrasan}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]\frametitle{Uttanapadasana}
\begin{columns}
    \begin{column}[T]{0.5\linewidth}
      \begin{itemize}
