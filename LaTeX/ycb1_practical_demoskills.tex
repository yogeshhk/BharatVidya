...
\begin{columns}
    ...
    \begin{column}[T]{0.5\linewidth}
        \begin{center}
		        \includegraphics[width=0.6\linewidth,keepaspectratio]{ycb1_tadasan}
...
\begin{columns}
    ...
    \begin{column}[T]{0.5\linewidth}
        \begin{center}
		        \includegraphics[width=0.6\linewidth,keepaspectratio]{ycb1_vrikshasan}
...
\begin{columns}
    ...
    \begin{column}[T]{0.5\linewidth}
        \begin{center}
        \begin{center}
		        \includegraphics[width=0.8\linewidth,keepaspectratio]{ycb1_katichakrasan}
